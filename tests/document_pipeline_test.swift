...
@main struct DocumentPipelineTests {
    static func main() throws {
        ...
        print("PASS: Copy ownership independently blocks exported-document expiry; releasing it permits bounded cleanup without touching external output.")
        ...
        try JSONSerialization.data(withJSONObject:["outcome":"completedSafe","image_complete":true]).write(to:legacy.appendingPathComponent("outcome.json"))
