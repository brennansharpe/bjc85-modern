...
extension UtilityWindowController {
    ...
    func makeMenus() {
        ...
        _=submenu("File",entries:[("New document",#selector(newDocument),"n"),("Open image…",#selector(openImage),"o"),("Retained documents…",#selector(showRetainedDocuments),""),("Export…",#selector(exportDocument),"s"),("Print document…",#selector(printDocument),"p"),("",nil,""),("Close",#selector(closeCurrentWindowOrDocument),"w"),("Discard document…",#selector(discardDocument),"")])
